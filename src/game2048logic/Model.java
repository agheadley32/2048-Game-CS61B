    ...
    public boolean atLeastOneMoveExists() {
        ...
        for (int x = 0; x < getBoard().size(); x++) {
            for (int y = 0; y < getBoard().size(); y++) {
                ...
                if (y < board.size() - 1 && value == tile(x, y + 1).value()) {
                    return true;
                }
                if (y > 0 && value == tile(x, y - 1).value()) {
                    return true;
                }
                if (x < board.size() - 1 && value == tile(x + 1, y).value()) {
                    return true;
                }
                if (x > 0 && value == tile(x - 1, y).value()) {
                    return true;
                }
            }
        }
